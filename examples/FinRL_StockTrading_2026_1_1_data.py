...
# %% Part 2. Fetch data - US_VOL

print("\n=== HIGH_LOW Volatility Tickers ===")
print(config_tickers.JP_HIGH_LOW_VOL)

df_raw = YahooDownloader(
    start_date=TRAIN_START_DATE,
    end_date=TRADE_END_DATE,
    ticker_list=config_tickers.JP_HIGH_LOW_VOL,
).fetch_data()
print("\n=== Raw data ===")
print(df_raw.head())
...
train.to_csv("train_data_JP_HIGH_LOW_VOL.csv")
trade.to_csv("trade_data_JP_HIGH_LOW_VOL.csv")
print("Data saved to train_data_JP_HIGH_LOW_VOL.csv and trade_data_JP_HIGH_LOW_VOL.csv")
